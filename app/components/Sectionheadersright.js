        ...
        <section className="py-10 border-t sm:py-16 lg:py-24">
            <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                <div className="mx-auto  md:max-w-lg lg:max-w-3xl text-center">
                    ...
                    <p className='text-lg leading-relaxed text-gray-600' >I had gauged an interest in entrepreneurship when I had first interned with my mother in 7th grade and since then wanted to learn more about the disciplines behind running a business that can make an impactful change on society.</p>
                </div>
