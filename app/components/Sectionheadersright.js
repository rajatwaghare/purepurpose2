        ...
        <section className="py-10 border-t sm:py-16 lg:py-24">
            <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 mt-8 md:mt-20 gap-y-6 md:grid-cols-2 gap-x-10 text-center md:text-left items-center ">
                    ...
                    <div>
                        <Image className="w-full mx-auto sm:max-w-xs rounded-3xl leading-relaxed" src="https://cdn.rareblocks.xyz/collection/celebration/images/team/2/business-man.jpg" alt=""></Image>
                    </div>
                </div>
