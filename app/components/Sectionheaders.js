        ...
        <section className="py-20 sm:py-16 lg:py-24">
            <div className="max-w-5xl px-6 md:px-4 mx-auto sm:px-6 lg:px-8">
                <div className="mx-auto md:max-w-lg lg:max-w-3xl text-center">
                    ...
                    <div>
                        <img className="w-full mx-auto rounded-2xl my-10 md:my-16  sm:max-w-xs" src="https://cdn.rareblocks.xyz/collection/celebration/images/team/2/business-man.jpg" alt="" />
                    </div>
